...
const StudentList = () => {
  ...
  return (
    <div className="p-8">
      <SectionHeaderWithSearch title={'Danh sách học sinh'} placeholder={'Tìm học sinh'} setQuery={setQuery} />
        ...
        <div className="flex justify-center flex-col gap-3">
          <div>
            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
              <div className="text-xl font-semibold leading-6 text-gray-900">Xóa học sinh</div>
      ...
      <Modal open={isModalEdit} onCancel={onCancel} footer={false} centered>
        <div className="text-center w-full text-xl font-semibold my-3">Sửa thông tin học sinh</div>
        {editData && (
